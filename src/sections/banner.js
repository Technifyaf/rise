...
import BannerImage from 'assets/rise.jpg';
          ...
          <Box sx={styles.banner.col}>
            <Box sx={styles.banner.content}>
              <Box sx={styles.banner.stars}>
                ...
                <FaStar />
                <FaStar />
                Trused by over 332 fellows
              </Box>
              <Heading as="h3">
              Relationships inspiring social<br/> enterprise
              </Heading>
              <Text as="p">
              We collaborate with talent in local communitiies to educate and empower them to solve the challenges they face in a sustainable way.
              </Text>
...
const styles = {
  banner: {
    ...
    backgroundImage: [
      'linear-gradient(-180deg, #E0F5FA 0%, #FFFFFF 100%)',
      `url(${BannerBG})`,
    ],
