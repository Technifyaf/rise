...
const accordionData = [
  {
    isExpanded: false,
    title: 'How do I become a rise fellow',
    contents: (
      <div>
       To become a rise fellow , you need to meet 1 2 3 4 conditions
      </div>
    ),
  },
  {
    isExpanded: true,
    title: 'Is rise a vocational school ?',
    contents: (
      <div>
       No rise is not a vocational school
      </div>
    ),
  },
  {
